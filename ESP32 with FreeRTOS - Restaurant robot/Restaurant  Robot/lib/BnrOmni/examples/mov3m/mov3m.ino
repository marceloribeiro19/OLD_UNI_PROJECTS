/*
 ...
 Purpose:
  This example demonstrates linear movimentation of 3 motors without PID control
...
void setup()
{
    ...
    omni.setRamp(15,900);             // set acceleration ramp and limiar movemet parameter gain[int slope, int Kl] slope between 0 and 100 kl->gain for necessary motor power to start movement
