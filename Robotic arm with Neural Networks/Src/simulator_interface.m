...
%   2022/03/17
    ...
    methods
        ...
        function [obj,error] = simulator_interface(remote_ip_address, remote_port)
            ...
            %robot handle for targets
            obj.TARGET_Number=7;
            
            % target handle

            obj.targetName{1} = 'CuboVermelho';
            obj.targetName{2} = 'CuboVerde';
            obj.targetName{3} = 'CilindroVerde';
            obj.targetName{4} = 'TargetCuboVermelho';
            obj.targetName{5} = 'TargetCuboVerde';
            obj.targetName{6} = 'TargetCilindroVerde';
            obj.targetName{7} = 'Dummy';
             

            for t=1:obj.TARGET_Number
                [res,obj.TargetHandle{t}]=obj.vrep.simxGetObjectHandle(obj.clientID,obj.targetName{t},obj.vrep.simx_opmode_blocking);
        ...
        function [error,tposition] = get_TargetPosition( obj, t)
